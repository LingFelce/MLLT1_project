---
title: "Clustering - SUM159"
output: html_document
---

Update: 28th April 2020

# Clustering of all SUM159 samples
...
SUM_only <- all_samples [, c("SUM.MLLT1.1.1_S2", "SUM.MLLT1.1.2_S4", "SUM.MLLT1.2.1_S14", "SUM.MLLT1.2.2_S18", "SUM.NEG.1_S16", "SUM.NEG.2_S5")]

write.table(SUM_only, sep="\t",file="SUM_genes.tsv")

df_mRNA <- read.table("SUM_genes.tsv", sep = "\t", header = TRUE)
...
write.csv(pca_symbol, "sum_pca_genes.csv")
