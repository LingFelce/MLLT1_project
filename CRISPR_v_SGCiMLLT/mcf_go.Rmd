...
```{r}
library(readr)
genes_24h <- read_csv("go2/mcf_shared_genes_24h_down.csv")
genes_24h[1] <- NULL
...
genes_24h_filter <- genes_24h %>%
  filter(crispr_1_LFC < -0.075)
genes_24h_filter <- genes_24h_filter %>%
  filter(crispr_2_LFC < -0.075)
genes_24h_filter <- genes_24h_filter %>%
  filter(sgc_24h_LFC < -0.075)
...
```{r}
library(readr)
genes_24h <- read_csv("go2/mcf_shared_genes_24h_up.csv")
genes_24h[1] <- NULL
...
```{r}
library(readr)
genes_7d <- read_csv("go2/mcf_shared_genes_7d_down.csv")
genes_7d[1] <- NULL
...
```{r}
library(readr)
genes_7d <- read_csv("go2/mcf_shared_genes_7d_up.csv")
genes_7d[1] <- NULL
