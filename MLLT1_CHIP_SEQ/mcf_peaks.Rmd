...
Previously - aligned .fastq files to .bam, removed duplicates. Used Homer to find peaks in DMSO samples, then annotate peaks using DMSO + SGC files. Analyse factor style peaks only. Redid annotatePeaks function to have two columns for DMSO and SGC-iMLLT Tag Densities
...
geneset <- as.character(peaks_7d_decrease$Entrez.ID)
