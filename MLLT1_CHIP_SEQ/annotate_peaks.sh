...
# normalisation for SUM159, not for MCF-7
...
annotatePeaks.pl tss hg38 -norm 6672871.029 \
-list sum_shared_genes_7d_down_all.txt \
-d SUM_DMSO_24H_IP/ SUM_SGC_24H_IP/ -size 2000 -hist 100 > results/SUM_MLLT1_24H_down_degs_tss.txt 

annotatePeaks.pl tss hg38 -norm 7550759.462 \
-list sum_shared_genes_7d_down_all.txt \
-d SUM_DMSO_7D_IP/ SUM_SGC_7D_IP/ -size 2000 -hist 100 > results/SUM_MLLT1_7D_down_degs_tss.txt

annotatePeaks.pl tss hg38 -norm 6672871.029 \
-list sum_shared_genes_7d_up_all.txt \
-d SUM_DMSO_24H_IP/ SUM_SGC_24H_IP/ -size 2000 -hist 100 > results/SUM_MLLT1_24H_up_degs_tss.txt 

annotatePeaks.pl tss hg38 -norm 7550759.462 \
-list sum_shared_genes_7d_up_all.txt \
-d SUM_DMSO_7D_IP/ SUM_SGC_7D_IP/ -size 2000 -hist 100 > results/SUM_MLLT1_7D_up_degs_tss.txt
