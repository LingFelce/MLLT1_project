...
@collate('*.fastq.gz', regex(r'(.*)_R[1-2].fastq.gz'), r'quant/\1/abundances.h5') #find all fastq.gz files, output into quant folder/name of sample/abundances.h5 (one of 3 output files generated by default)
