...
# trim the last 2 base pairs off each read. Paired ends so need read 1 and read 2 fastq.gz files. 
# will have 4 output files, use first bit as base for each output file name (-baseout) otherwise would have to specify 4 file names
# (will do automatically - read 1 paired, read 1 unpaired, read 2 paired, read 2 unpaired)

#@follows(trimmomatic, mkdir('trimmed_fastqc')) #check trimmed fastq.gz files
