...
# remove duplicated rows - 225 genes
...
ifn_gene_list <- as.character(ifn_genes)
...
# sort patients by MLLT1 expression

sorted_ifn_exp <- ifn_exp[order(ifn_exp["MLLT1",]),]

mrna_median_all_samples_zscores[c("MLLT1"),]
