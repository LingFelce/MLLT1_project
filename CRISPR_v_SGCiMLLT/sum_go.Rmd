...
```{r}
library(readr)
genes_24h <- read_csv("sum_shared_genes_24h_down.csv")
genes_24h[1] <- NULL
...
# Filter genes with -0.05 log2 fold change
genes_24h_filter <- genes_24h %>%
  filter(crispr_1_LFC < -0.05)
genes_24h_filter <- genes_24h_filter %>%
  filter(crispr_2_LFC < -0.05)
genes_24h_filter <- genes_24h_filter %>%
  filter(run2_24h_LFC < -0.05)
genes_24h_filter <- genes_24h_filter %>%
  filter(merge_24h_LFC < -0.05)
...
```{r}
library(readr)
genes_24h <- read_csv("sum_shared_genes_24h_up.csv")
genes_24h[1] <- NULL
...
```{r}
library(readr)
genes_7d <- read_csv("sum_shared_genes_7d_down.csv")
genes_7d[1] <- NULL
...
```{r}
library(readr)
genes_7d <- read_csv("sum_shared_genes_7d_up.csv")
genes_7d[1] <- NULL
